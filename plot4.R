...
plot(datetime, mydata_sub$Global_active_power, type="l", xlab="", ylab="Global Active Power") ###top left plot

plot(datetime,mydata_sub$Voltage, type="l", xlab="datetime", ylab="Voltage") ###top right plot

plot(datetime,mydata_sub$Sub_metering_1,type = "n",ylab="Energy sub metering", xlab="", ) ###bottom left plot
...
plot(datetime,mydata_sub$Global_reactive_power, type="l", xlab="datetime", ylab="Global_reactive_power")  ###bottom right plot
